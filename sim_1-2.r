...
#    alpha.vec = 1:20
    ...
    df.vec = seq(log(4),log(1),length = 20)
    alpha = 10
    for (k in 1:length(df.vec))
    {
    df = exp(df.vec[k])
...
#  setwd('D:\\JJJ\\ranking problem\\Jeon-2014-03-05 order consistency\\rank-consistenmcy_ver04-JJ')
  df.vec = exp(df.vec)
  # jpeg(filename = "Rplot5.jpg")
  # plot(df.vec, beta.mat1[,1], type = 'b', lty = 1, ylim = c(0,3),
  #      ylab = expression(beta), xlab = expression(alpha), main = 'mean of estimated coefficients',
  #      pch = 1)
  # lines(df.vec, beta.mat1[,2], lty = 2,type = 'b', pch = 2)
  # lines(df.vec, beta.mat1[,3], lty = 3, type = 'b',pch = 3)
  # lines(df.vec, beta.mat1[,4], lty = 4, type = 'b',pch = 4)
  # dev.off()
  # jpeg(filename = "Rplot6.jpg")
  # plot(df.vec, beta.mat2[,1], type = 'b', lty = 1, ylim = c(0,3),
  #      ylab = expression(beta), xlab = expression(alpha), main = 'mean of estimated coefficients',
  #      pch = 1)
  # lines(df.vec, beta.mat2[,2], lty = 2,type = 'b', pch = 2)
  # lines(df.vec, beta.mat2[,3], lty = 3, type = 'b',pch = 3)
  # lines(df.vec, beta.mat2[,4], lty = 4, type = 'b',pch = 4)
  # dev.off()
  png(filename = "Rplot7.png")
  plot(1/df.vec, rank.mat1[,1], type = 'b', lty = 1, ylim = c(0,4.2),
       ylab = "averages of estimated ranks", xlab = expression(paste('1/', nu)), 
       main = 'BT',
       pch = 20, cex.lab = 1.5, cex.axis = 1.3)
  lines(1/df.vec, rank.mat1[,2], lty = 1,type = 'b', pch = 2)
  lines(1/df.vec, rank.mat1[,3], lty = 1, type = 'b',pch = 3)
  lines(1/df.vec, rank.mat1[,4], lty = 1, type = 'b',pch = 4)
  ...
  png(filename = "Rplot8.png")
  plot(1/df.vec, rank.mat2[,1], type = 'b', lty = 1, ylim = c(0,4.2),
       ylab = "averages of estimated ranks", xlab = expression(paste('1/', nu)), 
       main = 'gBT',
       pch = 20, cex.lab = 1.5, cex.axis = 1.3)
  lines(1/df.vec, rank.mat2[,2], lty = 1,type = 'b', pch = 2)
  lines(1/df.vec, rank.mat2[,3], lty = 1, type = 'b',pch = 3)
  lines(1/df.vec, rank.mat2[,4], lty = 1, type = 'b',pch = 4)
  legend('bottomright', legend = c(expression(paste(lambda[1], "     ")),
                                   expression(lambda[2]),
                                   expression(lambda[3]),
                                   expression(lambda[4])),
  ...
  plot(1/df.vec, rank.mat2[,1], type = 'b', lty = 1, ylim = c(0,4),
       ylab = expression(lambda), xlab = expression(paste('1/', nu)), main = 'averages of estimated ranks',
       pch = 1)
  lines(1/df.vec, rank.mat2[,2], lty = 2,type = 'b', pch = 2)
  lines(1/df.vec, rank.mat2[,3], lty = 3, type = 'b',pch = 3)
  lines(1/df.vec, rank.mat2[,4], lty = 4, type = 'b',pch = 4)
